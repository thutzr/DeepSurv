...
weights_file_name = weights_file_names[1]
title_name = title_names[1]

metrics = model.train(train_data[1],test_data[1],n_epochs,
                      validation_frequency=valid_freq,
                       update_fn=update_fn)

print(model.get_concordance_index(**test_data[1]))
